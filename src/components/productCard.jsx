    ...
    >
      ...
      <div className="p-4 flex flex-col justify-between h-[100px]">
        ...
        <div className="flex justify-between items-center mt-2">
          {
            (product.price > product.lastPrice )&&<p className="text-xl font-bold text-red-500 line-through">${product.price}</p>
          }
          <p className="text-xl font-bold text-red-500">${product.lastPrice}</p>
          {product.stock > 0 ? (
